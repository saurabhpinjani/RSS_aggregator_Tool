...
def es_database_setup():
	...
	cwd = os.getcwd()
	file_obj=open(cwd+"/Data_Files/"+'arxiv_title_hash_file.txt','w') # clears the file containing the title of the journal in the database
	file_obj.close() 
...
def es_clear_feed_database(): #This function is used to remove all the feeds from the database
	...
	cwd = os.getcwd()
	file_obj=open(cwd+"/Data_Files/"+'arxiv_title_hash_file.txt','w')
	file_obj.close() 
...
def fill_title_hash(): # creates a hash table of the titles of all the articles in the database
	...
	cwd = os.getcwd()
	title_hash={}
	with open(cwd+"/Data_Files/"+'arxiv_title_hash_file.txt','r') as file_obj:
